  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-4 md:p-0">
      ...
      <button
        ...
        title={t.chatTitle}
        className="fixed bottom-6 right-6 z-40 w-14 h-14 rounded-full bg-blue-600 hover:bg-blue-500 text-white shadow-xl flex items-center justify-center transition-all duration-200 hover:scale-110 hover:shadow-blue-500/40"
      >
